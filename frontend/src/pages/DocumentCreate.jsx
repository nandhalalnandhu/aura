    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          "Failed to generate AI content. Try again."
      );
    } finally {
      setAiLoading(false);
    }
      ...
      >
        ...
        <div className="mb-4">
          ...
          <button
            ...
            className={`bg-green-500 hover:bg-green-700 text-white text-sm py-1 px-3 rounded mb-2 focus:outline-none focus:shadow-outline flex items-center justify-center ${
